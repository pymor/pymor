...
install_suggests = {
    ...
    'dune-gdt>=2022.5.0.3; platform_system=="Linux" and platform_machine=="x86_64"': 'generic discretization toolbox',
    'dune-xt>=2022.5.0.3; platform_system=="Linux" and platform_machine=="x86_64"': 'DUNE extensions for dune-gdt',
}
