...
Options:
  ...
  --test=COUNT                       Use COUNT snapshots for stochastic error estimation
                                     [default: 10].
  --greedy-without-error-estimator   Do not use error estimator for basis generation.
"""
...
def main(args):
    ...
    if args['--alg'] == 'naive':
        ...
        parallel = not (args['--fenics'] and args['--greedy-without-error-estimator'])  # cannot pickle FEniCS model
        rom, red_summary = reduce_greedy(fom=fom, reductor=reductor, parameter_space=parameter_space,
                                         ...
                                         use_error_estimator=not args['--greedy-without-error-estimator'],
