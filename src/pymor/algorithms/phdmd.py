...
def phdmd(X, Y, U, Xdot=None, dt=None, H=None, initial_J=None, initial_R=None, initial_alpha=0.1, miniter=0,
    ...
    data
        Dict containing the following fields:
            ...
            :skew_init_data:        If `initial_J` is `None`, dict of data generated by the
                                    skew-symmetric Procrustes subproblem.
            :spsd_init_data:        If `initial_R` is `None`, dict of data generated by the psd
    ...
    if initial_J is None and initial_R is not None:
        ...
        initial_R, spsd_data = _psd_symmetric_procrustes(T, initial_J @ T - Z)
...
def _skew_symmetric_procrustes(X, Y, rtol=1e-12):
    ...
    Computes a skew symmetric solution A of the minimization problem ::
...
def _psd_symmetric_procrustes(X, Y, reg=1e-6):
    """Solve the psd symmetric Procrustes problem.

    Computes a psd symmetric solution A of the minimization problem ::
