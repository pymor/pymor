...
def _get_dunegdt_version():
    ...
    try:
        ...
        if parse(version) < parse('2021.1.2') or parse(version) >= parse('2021.2'):
            warnings.warn(f'dune-gdt bindings have been tested for version 2021.1.x (x >= 2) '
    ...
    try:
        ...
        if parse(xt_version) < parse('2021.1.2') or parse(xt_version) >= parse('2021.2'):
            warnings.warn(f'dune-gdt bindings have been tested for dune-xt 2021.1.x (x >= 2) '
