    ...
    def discretize_instationary_cg(analytical_problem, diameter=None, domain_discretizer=None, grid_type=None,
        ...
        preassemble
            ...
            ensure_consistent_initial_values
                If not `None`, tolerance to decide if initial values fulfill the Dirichlet data.
                If the L^\infty error w.r.t. the Dirichlet data (after interpolation) is above the
                tolerance, the initial values are lifted by applying one time step.
