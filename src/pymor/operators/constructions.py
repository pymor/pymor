...
class OutputOperator(Operator):
    ...
    def _prepare_lincomb_dicts(self, operator_dict):
        for key in operator_dict:
            assert operator_dict[key], f"The key '{key}' does not contain any value!"
    ...
    def _prepare_coefficient_dicts(self, operator_dict, coefficient_dict, solver_options, name):
        ...
        for key in keys:
            ...
            assert operator_dict[key] and coefficient_dict[key], f"The key '{key}' does not contain any value!"
