...
class NonlinearAdvectionOperator(OperatorBase):
    ...
    def __init__(self, grid, boundary_info, numerical_flux, dirichlet_data=None, solver_options=None, name=None):
        ...
        self.add_with_arguments = self.add_with_arguments.union('numerical_flux_{0}'.format(arg)
    ...
    def restricted(self, dofs):
        ...
        op = self.with_(grid=sub_grid, boundary_info=sub_boundary_info, name='{0}_restricted'.format(self.name))
