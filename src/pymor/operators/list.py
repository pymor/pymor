...
class NumpyListVectorArrayMatrixOperator(ListVectorArrayOperatorBase, NumpyMatrixOperator):
    ...
    # TODO: update
    def _apply_inverse_one_vector(self, v, mu=None, initial_guess=None, prepare_data=None):
    ...
    def _apply_inverse_adjoint_one_vector(self, u, mu=None, initial_guess=None, prepare_data=None):
        raise NotImplementedError
