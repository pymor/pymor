...
class Operator(ParametricObject):
    ...
    def apply_inverse(self, V, mu=None, initial_guess=None, solver=None):  ## TODO: document solver
        ...
        if solver := (solver or self.solver):
            return solver.solve(self, V, mu=mu, initial_guess=initial_guess)
        ...
        if (assembled_op is not self
            ...
            if assembled_op.solver:
                return assembled_op.solver.solve(assembled_op, V, initial_guess=initial_guess)
            try:
    ...
    def apply_inverse_adjoint(self, U, mu=None, initial_guess=None, solver=None):  ## TODO: document solver
        ...
        # if we have a solver, use it
        if solver := (solver or self.solver):
            return solver.solve_adjoint(self, U, mu=mu, initial_guess=initial_guess)
...
class LinearSolver(Solver):
    ...
    def solve_adjoint(self, operator, U, mu=None, initial_guess=None):
        self.solve(operator.H, U, mu=mu, initial_guess=initial_guess)
...
class AdjointLinearSolver(LinearSolver):
    ...
    def solve_adjoint(self, operator, U, mu=None, initial_guess=None):
        return self.solver.solve(operator.H, mu=mu, initial_guess=initial_guess)
