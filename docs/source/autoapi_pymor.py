...
MANUAL_SKIPS = ('RENDER_FRAGMENT_SHADER',
                ...
                'pymor.bindings.fenicsx.FenicsxInterpolationOperator.linear',
                'pymor.bindings.fenicsx.FenicsxInterpolationOperator.source',
                'pymor.bindings.scipy.ScipyLSMRSolver.least_squares',
                'pymor.bindings.scipy.ScipyLSQRSolver.least_squares',
                'pymor.bindings.scipy.ScipyLSTSQSolver.least_squares',
                'pymor.bindings.scipy.ScipyQRLSTSQSolver.least_squares',
                ...
                'pymor.models.iosys.ImpulseFunction.dim_domain',
                'pymor.models.iosys.StepFunction.dim_domain',
                ...
                'pymor.solvers.generic.LSMRSolver.least_squares',
                'pymor.solvers.generic.LSQRSolver.least_squares',
                'pymor.solvers.interface.AdjointSolver.jacobian_solver',
                'pymor.solvers.interface.AdjointSolver.least_squares',
