...
of the `VectorArrayInterface` interface is now assumed to have copy-on-write
...
- :class:`CacheRegions <pymor.core.cache.CacheRegion>` now have a
  ...
  `!~pymor.core.interface.BasicInterface.uid` can be used instead.
...
^^^^^^^^^^^^^^^^^^^^^^^
- :meth:`!~pymor.operators.interfaces.OperatorInterface.apply_inverse_adjoint`
...
- Default implementation of :meth:`!~pymor.operators.interfaces.OperatorInterface.as_vector`
...
- The `dot` method of the `VectorArrayInterface` interface has been split into
    :meth:`!~pymor.vectorarrays.interfaces.VectorArrayInterface.dot` and
...
- Removal of the `options` parameter of :meth:`!~pymor.operators.interfaces.OperatorInterface.apply_inverse`
    in favor of :attr:`!~pymor.operators.interfaces.OperatorInterface.solver_options` attribute
    `[#122] <https://github.com/pymor/pymor/issues/122>`_.  The `options` parameter of
    :meth:`!OperatorInterface.apply_inverse <pymor.operators.interfaces.OperatorInterface.apply_inverse>`
...
- Non-parametric objects have now :attr:`!~pymor.parameters.base.Parametric.parameter_type` `{}`
