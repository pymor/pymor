...
- :meth:`!reduce_parabolic` reduces linear parabolic
  ...
  The :mod:`!parabolic_mor` demo contains a simple sample
...
an attribute now can safely create copies of the passed `VectorArrayInterfaces` (to ensure
...
- Basic support for parabolic problems has been added.
  ...
  The :mod:`!parabolic` demo demonstrates the use of these methods
...
- |ListVectorArray|-based |NumpyMatrixOperator| `[#164] <https://github.com/pymor/pymor/pull/164>`_.
    ...
    The :mod:`!thermalblock` demo now has an option
