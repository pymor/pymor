...
`pymor.solvers.matrix_equations.sylvester`. A generic low-rank ADI (Alternating Direction
Implicit) solver for Lyapunov equations is implemented in
:mod:`pymor.solvers.matrix_equations.lradi`. Furthermore, bindings to low-rank and dense
...
:mod:`pymor.solvers.matrix_equations.sylvester`.
