...
systems-theoretic methods to pyMOR. Module :mod:`pymor.models.iosys`
...
:class:`~pymor.reductors.interpolation.LTIBHIReductor`. Two-Sided Iteration
...
:class:`~pymor.reductors.interpolation.SOBHIReductor` and Second-Order Reduced
IRKA (SOR-IRKA) in :class:`~pymor.reductors.sor_irka.SORIRKAReductor`.
...
:class:`~pymor.reductors.interpolation.TFBHIReductor` and Transfer Function
IRKA (TF-IRKA) in :class:`~pymor.reductors.h2.TFIRKAReductor`.
...
- The somewhat dubious concept of a `subtype` has been superseded by the concept
  ...
  in the space. The
  :attr:`~pymor.vectorarrays.interface.VectorSpace.id` attribute
...
- New methods with clear semantics have been introduced for the conversion of
  |VectorArrays| to
  (:meth:`~pymor.vectorarrays.interface.VectorArray.to_numpy`) and
  from (:meth:`~pymor.vectorarrays.interface.VectorSpace.from_numpy`)
...
- Inner products between |VectorArrays| w.r.t. to a given inner product
  ...
  :meth:`~pymor.vectorarrays.interface.VectorArray.inner` and
  :meth:`~pymor.vectorarrays.interface.VectorArray.norm` methods
  `[#407] <https://github.com/pymor/pymor/pull/407>`_.

- The `components` method of |VectorArrays| has been renamed to the more
  intuitive name
  :meth:`~pymor.vectorarrays.interface.VectorArray.dofs`
  `[#414] <https://github.com/pymor/pymor/pull/414>`_.

- The :meth:`!~pymor.vectorarrays.interface.VectorArray.l2_norm2` and
  :meth:`~pymor.vectorarrays.interface.VectorArray.norm2` have been
...
- The analytical problems and discretizers of pyMOR's discretization toolbox
  ...
  specifying a :class:`~pymor.analyticalproblems.functions.LincombFunction` as
  the respective data function
